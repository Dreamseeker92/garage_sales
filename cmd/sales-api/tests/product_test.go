...
func TestProducts(t *testing.T) {
	...
	tests := ProductTest{app: handlers.API(db, log)}
...
func (productTest *ProductTest) List(t *testing.T) {
	req := httptest.NewRequest("GET", "/v1/products", nil)
	resp := httptest.NewRecorder()

	productTest.app.ServeHTTP(resp, req)
...
func (productTest *ProductTest) ProductCRUD(t *testing.T) {
